...
?>
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
		...
		<legend><i class="fa fa-table"></i> {{Mes Scripts}}</legend>
				...
				<form class="form-horizontal">
					<fieldset>
						<div class="form-group">
							<label class="col-sm-2 control-label">{{Nom du Script}}</label>
							<div class="col-sm-3">
								<input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
								<input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom du Script}}"/>
							</div>
						</div>
						<div class="form-group">
...
<?php include_file('desktop', 'scriptssh', 'js', 'scriptssh');?>
